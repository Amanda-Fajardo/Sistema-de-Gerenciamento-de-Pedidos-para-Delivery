 ...
 */
package com.mycompany.evai.view;

/**
 *
 * @author amand
 */
public class CardapioCliente extends javax.swing.JFrame {

    /**
     * Creates new form CardapioCliente
     */
    public CardapioCliente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CardapioCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CardapioCliente().setVisible(true);
            }
        });
    }
