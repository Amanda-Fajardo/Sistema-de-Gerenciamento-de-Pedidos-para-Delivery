 ...
 * @author va001
 */
public class TelaInicialCliente2 extends javax.swing.JFrame {

    /**
     * Creates new form TelaInicialCliente
     */
    public TelaInicialCliente2() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaInicialCliente2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
